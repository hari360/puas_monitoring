...
class Historyflmslm extends MY_Controller
{
  ...
  { 
    ...
    $terms = $this->Postilion_model->get_history_flm_slm();

    $tmpl = array(
        'table_open'    => '<table class="table table-bordered table-striped table-hover nowrap" id="dt_history_flm_slm" width="100%">',
        'thead_open'            => '<thead>',
        'thead_close'           => '</thead>',
    ...
    $data['table_history_flm_slm'] = $this->table->generate();
