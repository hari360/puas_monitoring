        ...
        <div class="container">
            <div class="row h-100 justify-content-center align-items-center">
                ...
                <div class="col-lg-4 center">
                    ...
                    echo form_open('accounts/forgotpass', $attributes);
                    ?>
                    ...
                    <?php } ?>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Email Name" name="email" id="txtusername" tabindex="5"  
                            value="<?php echo set_value('v_email', isset($default['v_email']) ? $default['v_email'] : ''); ?>" >
