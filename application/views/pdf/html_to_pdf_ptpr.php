...
<body style="font-size:10px;font-family: Arial, Helvetica, sans-serif;padding:50px">
	...
	<table>
		...
		<tr>
			<td>Kepada</td>
			<td>:</td>
			<td>PT. Rajawali Telekomunikasi Seluler</td>
		</tr>
		<tr>
			<td>Up</td>
			<td>:</td>
			<td>Operations RTS</td>
		</tr>
	</table>
<br>
	<table>
...
<br>
	<table class="tbl_data" >
		...
		<tr>
			...
			<td style="text-align: center;width:150px">BCA KCU Denpasar <br>0408787222</td>
			<td style="padding-left: 5px;">PT RAJAWALI TELEKOMUNIKASI SELULAR</td>
			<td style="text-align: right; padding-right: 5px;"><?= $amount ?></td>
			<td style="padding-left: 5px;">Settlement PTPR</td>
		</tr>
		<tr>
			<td></td>
			<td></td>
