      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="body">
            ...
            <!-- <?php
                  $attributes = array(
                    'name' => 'upload_form_terminal', 'id' => 'formuploadterminal', 'autocomplete' => 'off', 'enctype' => 'multipart/form-data', 'class' => 'card auth_form'
                  );
  ...
  <div class="modal-dialog modal-lg" role="document" style="font-size: 12px;border:0px solid red;">
    <div class="modal-content">
      ...
      <div class="modal-body form" style="border: 0px solid red;padding-top: 0px">
        <div class="loader" id="loader_process_edit">
          ...
          <div class="form-body">
            ...
            <div class="row clearfix">
              <div class="loader col-sm-12" id="loader_process">
                <div class="m-t-30"><img class="zmdi-hc-spin" src="<?php echo base_url() ?>assets/images/loader.svg" width="48" height="48" alt="Aero">
                </div>
                <p>Processing...</p>
              </div>
              <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                ...
                <p id="txt_full_name_term_access">-</p>
                <hr>
                <!-- <input id="txt_full_name_term_access" type="text" class="form-control"  /> -->
