        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card widget_2 big_icon alltrx">
                    <div class="body">
                        <h6>Approved</h6>
                        <h2><?= number_format($total_trx); ?> <small class="info">of 1,000 Trx</small></h2>
                        <small>Start from : 2021-09-12 00:00</small>
                        <div class="progress">
                    ...
                    <div class="body">
                        ...
                        <table style="width: 100%;border:0px solid red">
                            ...
                            <tr style="border-top: 1px solid">
                                <td>1,000</td>
                                <td>2021-09-21 17:00:00</td>
                                <td>2021-09-21 16:36:00</td>
                            </tr>
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Detail Transactions</strong> APPROVED</h2>
                    </div>
